...
export const ListingItem = ({listing,id,onEdit,onDelete}) => {
  return (
   <li className='bg-white flex flex-col justify-center items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 relative m-[10px]'>
